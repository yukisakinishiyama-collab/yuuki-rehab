  ...
  return (
    <g opacity="0.9">
      ...
      <path d="
        M 90,5 L 90,44
        C 88,56 80,68 68,82
        C 58,95 54,110 58,124
        C 62,134 72,140 84,136
        C 90,132 96,126 100,122
        C 104,126 110,132 116,136
        C 128,140 138,134 142,124
        C 146,110 142,95 132,82
        C 120,68 112,56 110,44
        L 110,5 Z"
        fill="#eddfc0" stroke="#b09060" strokeWidth="1.5"/>
      {/* 顆間隆起のライン（内側顆と外側顆の間のくびれ） */}
      <path d="M 84,138 C 90,144 100,146 100,146 C 100,146 110,144 116,138"
        fill="none" stroke="#c8a870" strokeWidth="1" opacity="0.6"/>
      {/* 膝蓋骨：楕円形 */}
      <path d="
        M 82,60
        C 70,68 66,84 68,100
        C 70,114 80,124 100,126
        C 120,124 130,114 132,100
        C 134,84 130,68 118,60
        C 110,54 90,54 82,60 Z"
        fill="#e8d4b2" stroke="#b09060" strokeWidth="1.5"/>
      {/* 脛骨：広い平台から骨幹へ */}
      <path d="
        M 56,137
        C 50,137 48,147 50,157
        C 52,167 66,173 80,175
        L 80,232 L 94,232 L 94,175
        L 106,175 L 106,232 L 120,232
        L 120,175
        C 134,173 148,167 150,157
        C 152,147 150,137 144,137 Z"
        fill="#eddfc0" stroke="#b09060" strokeWidth="1.5"/>
      {/* 脛骨棘（顆間隆起）：中央の小突起 */}
      <path d="M 94,135 Q 97,128 100,126 Q 103,128 106,135"
        fill="#eddfc0" stroke="#b09060" strokeWidth="1.2"/>
      {/* 関節軟骨面（脛骨上面） */}
      <path d="M 58,135 Q 100,128 142,135"
        fill="none" stroke="#88b0a0" strokeWidth="1.5" opacity="0.8"/>
      {/* 腓骨頭：外側の小円 */}
      <path d="M 148,152 C 146,142 155,136 163,143 C 170,150 168,166 159,169 C 150,171 144,162 148,152 Z"
        fill="#eddfc0" stroke="#b09060" strokeWidth="1.5"/>
      {/* 腓骨体 */}
      <path d="M 154,169 L 152,232 L 162,232 L 162,170 Z"
        fill="#eddfc0" stroke="#b09060" strokeWidth="1.2"/>
    </g>
  )
}
...
function ShoulderSilhouette() {
  // 前面観：鎖骨・肩峰・肩甲骨関節窩・上腕骨頭
  return (
    <g opacity="0.9">
      {/* 鎖骨：内側から外側へ緩やかなS字カーブ */}
      <path d="M 22,54 C 38,40 58,34 78,33 C 90,32 98,36 100,42 L 100,50 C 96,46 88,44 78,44 C 58,46 40,52 26,64 Z"
        fill="#eddfc0" stroke="#b09060" strokeWidth="1.5"/>
      {/* 肩峰：鎖骨外側端から突出する水平突起 */}
      <path d="M 76,26 C 84,20 98,22 105,30 C 110,36 108,44 100,48 C 95,50 88,48 84,42 C 80,36 78,30 76,26 Z"
        fill="#eddfc0" stroke="#b09060" strokeWidth="1.5"/>
      {/* 肩甲骨体部＋関節窩 */}
      <path d="
        M 52,42 C 42,48 40,68 40,96
        C 40,126 44,172 48,198
        C 52,208 62,212 72,210
        L 90,207 L 90,58
        C 88,52 84,46 80,40
        C 74,34 62,38 52,42 Z"
        fill="#eddfc0" stroke="#b09060" strokeWidth="1.5"/>
      {/* 関節窩（軟骨面）：縦線 */}
      <path d="M 90,76 L 90,148"
        fill="none" stroke="#88b0a0" strokeWidth="2.5" opacity="0.7"/>
      {/* 上腕骨頭：大きな球形 */}
      <path d="
        M 90,76
        C 90,55 108,46 128,50
        C 152,55 176,74 180,100
        C 184,126 172,154 154,164
        C 140,172 122,168 110,158
        C 96,147 90,132 90,114 Z"
        fill="#eddfc0" stroke="#b09060" strokeWidth="1.5"/>
      {/* 大結節：上腕骨頭外側の突起 */}
      <path d="M 180,88 C 186,82 194,88 194,100 C 194,112 186,118 180,112 C 175,106 175,96 180,88 Z"
        fill="#e8d4b2" stroke="#b09060" strokeWidth="1.2"/>
      {/* 上腕骨体 */}
      <path d="M 108,162 L 100,255 L 116,255 L 122,164 Z"
        fill="#eddfc0" stroke="#b09060" strokeWidth="1.5"/>
    </g>
  )
}
...
function HipSilhouette() {
  // 前面観：腸骨稜・ASIS・寛骨臼・大腿骨頭・大転子
  return (
    <g opacity="0.9">
      {/* 腸骨稜（上縁のアーチ） */}
      <path d="
        M 6,48 C 8,20 34,6 60,6
        C 84,6 100,16 108,30
        C 114,40 118,56 120,70
        L 112,72
        C 110,58 106,44 100,34
        C 90,20 74,14 58,16
        C 36,18 20,30 18,52 Z"
        fill="#eddfc0" stroke="#b09060" strokeWidth="1.5"/>
      {/* 上前腸骨棘（ASIS）：前方突出部 */}
      <path d="M 105,66 C 110,58 120,58 122,68 C 124,78 118,86 110,84 C 104,82 100,74 105,66 Z"
        fill="#e8d4b2" stroke="#b09060" strokeWidth="1.5"/>
      {/* 寛骨臼（関節窩）：関節軟骨面 */}
      <path d="M 76,68 C 78,52 90,46 106,50 L 122,72
        C 128,84 128,100 122,112
        C 116,124 104,130 92,128
        C 80,124 72,114 72,100
        C 72,86 74,76 76,68 Z"
        fill="#d8e8de" stroke="#88b0a0" strokeWidth="1.5"/>
      {/* 大腿骨頭：球形 */}
      <circle cx="98" cy="98" r="30" fill="#eddfc0" stroke="#b09060" strokeWidth="1.5"/>
      {/* 大腿骨頸部 */}
      <path d="M 118,114 C 132,120 148,130 156,142 L 160,156
        C 148,160 134,152 122,140
        C 112,130 110,118 112,110 Z"
        fill="#eddfc0" stroke="#b09060" strokeWidth="1.5"/>
      {/* 大転子：外側の大きな突起 */}
      <path d="
        M 155,128 C 146,118 160,108 170,116
        C 180,126 180,144 168,150
        C 158,156 148,148 155,136 Z"
        fill="#e8d4b2" stroke="#b09060" strokeWidth="1.5"/>
      {/* 大腿骨体 */}
      <path d="M 142,154 L 134,260 L 150,260 L 156,156 Z"
        fill="#eddfc0" stroke="#b09060" strokeWidth="1.5"/>
      {/* 小転子：内側の小突起 */}
      <path d="M 114,154 C 110,148 120,142 126,150 C 130,158 124,166 118,164 Z"
        fill="#e8d4b2" stroke="#b09060" strokeWidth="1.2"/>
    </g>
  )
}
...
function AnkleSilhouette() {
  // 前面観：脛骨（内側・太い）・腓骨（外側・細い）・内果・外果・距骨・踵骨
  return (
    <g opacity="0.9">
      {/* 脛骨体（内側・幅広） */}
      <path d="M 68,5 L 64,105 C 62,116 70,122 82,124 L 98,124 C 108,122 112,114 110,104 L 106,5 Z"
        fill="#eddfc0" stroke="#b09060" strokeWidth="1.5"/>
      {/* 内果（脛骨内側突起）：やや高位 */}
      <path d="
        M 50,112 C 44,114 40,126 42,138
        C 44,150 56,156 68,152
        C 78,148 84,138 80,126
        C 77,116 64,108 50,112 Z"
        fill="#eddfc0" stroke="#b09060" strokeWidth="1.5"/>
      {/* 腓骨体（外側・細い） */}
      <path d="M 120,5 L 118,100 C 116,110 122,118 132,120 C 142,120 150,112 150,102 L 148,5 Z"
        fill="#eddfc0" stroke="#b09060" strokeWidth="1.5"/>
      {/* 外果（腓骨外側突起）：内果より遠位に位置 */}
      <path d="
        M 138,110 C 148,108 158,120 158,136
        C 158,152 148,162 136,158
        C 124,154 118,142 122,128
        C 126,116 130,112 138,110 Z"
        fill="#eddfc0" stroke="#b09060" strokeWidth="1.5"/>
      {/* 距骨（丸みのある上面） */}
      <path d="M 58,124 C 54,140 60,156 72,162 L 128,162 C 142,156 148,140 144,124 Z"
        fill="#eddfc0" stroke="#b09060" strokeWidth="1.5"/>
      {/* 距骨滑車ライン */}
      <path d="M 62,124 Q 100,116 140,124"
        fill="none" stroke="#88b0a0" strokeWidth="2" opacity="0.8"/>
      {/* 踵骨 */}
      <path d="
        M 45,162 C 38,164 36,180 38,200
        C 40,218 52,232 76,234
        L 114,234
        C 130,228 134,212 132,196
        C 130,178 120,164 110,162 Z"
        fill="#eddfc0" stroke="#b09060" strokeWidth="1.5"/>
    </g>
  )
}
...
function ElbowSilhouette() {
  // 前面観：上腕骨遠位・内外側上顆・肘頭・橈骨頭
  return (
    <g opacity="0.9">
      {/* 上腕骨体＋遠位部（骨幹から両側顆へ広がる） */}
      <path d="
        M 87,5 L 85,82
        C 83,94 70,106 60,114
        C 50,122 46,132 50,142
        C 54,152 66,156 78,150
        C 86,144 90,134 90,122
        L 110,122
        C 110,134 114,144 122,150
        C 134,156 146,152 150,142
        C 154,132 150,122 140,114
        C 130,106 117,94 115,82
        L 113,5 Z"
        fill="#eddfc0" stroke="#b09060" strokeWidth="1.5"/>
      {/* 内側上顆：内側の丸い突起（肘の内側のゴルフ肘の部位） */}
      <path d="M 42,108 C 34,108 28,118 30,130 C 32,142 44,148 56,144 C 66,140 70,130 66,120 C 62,110 52,106 42,108 Z"
        fill="#e8d4b2" stroke="#b09060" strokeWidth="1.5"/>
      {/* 外側上顆：外側の丸い突起（テニス肘の部位） */}
      <path d="M 158,108 C 166,108 172,118 170,130 C 168,142 156,148 144,144 C 134,140 130,130 134,120 C 138,110 148,106 158,108 Z"
        fill="#e8d4b2" stroke="#b09060" strokeWidth="1.5"/>
      {/* 肘関節面（滑車・小頭）ライン */}
      <path d="M 72,140 C 82,148 100,150 100,150 C 100,150 118,148 128,140"
        fill="none" stroke="#88b0a0" strokeWidth="2" opacity="0.8"/>
      {/* 肘頭（尺骨近位）：後方の突起 */}
      <path d="
        M 84,152 C 78,154 74,168 74,184
        L 74,245 L 88,245 L 88,186
        C 92,178 96,174 100,174
        C 104,174 108,178 112,186
        L 112,245 L 126,245 L 126,184
        C 126,168 122,154 116,152 Z"
        fill="#eddfc0" stroke="#b09060" strokeWidth="1.5"/>
      {/* 橈骨頭：外側の円形関節面 */}
      <path d="M 122,128 C 122,116 132,110 142,116 C 152,122 154,136 148,146 C 142,154 130,154 124,146 C 118,140 118,134 122,128 Z"
        fill="#e8d4b2" stroke="#b09060" strokeWidth="1.5"/>
      {/* 橈骨体 */}
      <path d="M 130,150 L 126,245 L 140,245 L 142,152 Z"
        fill="#eddfc0" stroke="#b09060" strokeWidth="1.2"/>
    </g>
  )
}
