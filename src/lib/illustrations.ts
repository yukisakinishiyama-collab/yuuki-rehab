...
export const ILLUSTRATION_SLOTS: IllustrationSlot[] = [
  ...
  { slot: 'fracture-cast-forearm',  label: '骨折・前腕ギプス',       usage: '骨折プロトコル／橈骨遠位端骨折後の患者説明' },
  { slot: 'fracture-clavicle-band', label: '骨折・鎖骨バンド',       usage: '鎖骨骨折の患者説明（固定具の一例）' },
  { slot: 'fracture-foot-walk',     label: '骨折・歩行装具',         usage: '足部骨折・疲労骨折の患者説明' },
  { slot: 'dislocation-sling',      label: '脱臼・三角巾固定',       usage: '肩脱臼の保護期／プロトコル患者提示画面' },
  { slot: 'dislocation-innermuscle', label: '脱臼・インナー訓練',    usage: '肩不安定症・Bankart修復後の筋力期' },
