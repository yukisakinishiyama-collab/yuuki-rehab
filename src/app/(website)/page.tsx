...
const testimonials = [
  {
    name: 'K.T さん（高校生・陸上部）',
    text: '大会前にシンスプリントが悪化して来院しました。原因をしっかり説明してもらい、運動療法で段階的に回復。大会に間に合うことができました。痛みが取れるだけでなく、再発しない体作りを教えてもらえたのがよかったです。',
    rating: 5,
  },
  {
    name: 'M.S さん（30代・バスケット愛好家）',
    text: 'ACL手術後のリハビリで通院しました。術後の不安も多かったですが、段階を追ってしっかり説明しながら進めてくれました。競技復帰まで丁寧にサポートしてもらい、今は試合にも出られています。',
    rating: 5,
  },
  {
    name: 'Y.N さん（中学生・サッカー部保護者）',
    text: 'オスグッドがひどく、整形外科では安静しか言われなかったのですが、こちらでは原因から丁寧に診てもらえました。運動しながら改善できる方法を教えてもらい、子どもも前向きになれました。',
    rating: 5,
  },
]
