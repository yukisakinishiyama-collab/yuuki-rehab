...
// ─── 骨折（保存療法・固定管理） ──────────────────────────────────────────────
const FRACTURE_CONSERVATIVE: ProtocolTemplate = {
  key: 'fracture_conservative',
  title: '骨折（保存療法）固定管理・リハビリテーション',
  joint: 'other',
  discussion: [
    {
      role: '柔道整復師',
      ...
      focus: '整復位の保持と固定管理',
      recommendations: [
        '骨折の施術は応急手当を除き医師の同意を得て行う（柔道整復師法）',
        '固定期間中も固定範囲外の関節は積極的に動かし拘縮・筋萎縮を予防する',
        '固定の緩み・圧迫・皮膚トラブルを毎回チェックし必要に応じて再固定',
        '腫脹の推移に合わせて固定の締め直し・変更を行う',
      ],
      cautions: [
        '転位（ずれ）の疑いがあれば直ちに医療機関へ',
        '固定による循環障害・神経圧迫の徴候（しびれ・蒼白・疼痛増悪）を見逃さない',
      ],
    },
    {
      role: '整形外科医視点',
      emoji: '🏥',
      focus: '骨癒合の確認と固定期間の決定',
      recommendations: [
        '固定期間の最終決定は画像所見（仮骨形成）に基づく — 下記はあくまで目安',
        '【部位別固定期間の目安】橈骨遠位端: ギプス4〜6週 / 鎖骨: バンドまたは三角巾3〜6週 / 肋骨: バストバンド2〜3週 / 中手骨・指骨: 3〜4週 / 第5中足骨基部（下駄骨折）: 4〜6週 / 足趾: バディテープ3〜4週（いずれも要確認）',
        '高齢者は骨癒合が遅延しやすく、若年者は短縮できる場合がある',
        '定期的な画像フォローで癒合を確認してから固定除去・荷重を進める',
      ],
      cautions: [
        '喫煙・糖尿病・ステロイド使用は骨癒合遅延のリスク因子',
        '遷延癒合・偽関節が疑われる場合は専門医へ',
      ],
    },
    {
      role: 'リハビリ担当PT視点',
      emoji: '💪',
      focus: '固定中からの機能維持と除去後の回復',
      recommendations: [
        '固定中から等尺性収縮（アイソメトリック）で筋萎縮を最小限に',
        '固定除去後の可動域回復は疼痛自制内で愛護的に進める',
        '上肢骨折では肩・肘・指の連動、下肢骨折では荷重の段階付けを重視',
      ],
      cautions: [
        '固定除去直後の骨は強度が不十分 — 急な負荷・衝撃を避ける',
        '複合性局所疼痛症候群（CRPS）の早期徴候（不釣合いな疼痛・腫脹・皮膚変化）に注意',
      ],
    },
  ],
  consensusNotes:
    '骨折の施術は応急手当を除き医師の同意が必要（柔道整復師法）。固定期間は部位・年齢・転位の程度で大きく変わるため、記載の週数は目安とし、最終判断は医師の画像評価に従うこと。固定中の全身管理（固定範囲外の運動）と除去後の段階的負荷が機能回復の鍵。',
  phases: [
    {
      order: 1,
      title: '固定期（整復・固定の維持）',
      goals: ['整復位・固定の維持', '腫脹・疼痛の管理', '固定範囲外の関節の可動性維持', '筋萎縮の最小化'],
      exercises: [
        { name: '固定範囲外の関節自動運動', dose: '各関節10回×3セット/日', notes: '上肢なら指・肩、下肢なら足趾・股関節など' },
        { name: '等尺性収縮訓練', dose: '5秒保持×10回×3セット', notes: '固定内の筋も疼痛のない範囲で' },
        { name: 'アイシング・挙上', dose: '受傷後72時間は積極的に', notes: '腫脹コントロール' },
        { name: '健側・体幹のコンディショニング', dose: '全身の活動量維持' },
      ],
      advanceCriteria: [
        { label: '医師による骨癒合確認', target: '画像で仮骨形成（必須）' },
        { label: '固定除去の許可', target: '医師の指示' },
        { label: '安静時疼痛', target: 'NRS 2以下（目安）' },
      ],
      precautions: [
        '固定期間の目安 — 橈骨遠位端4〜6週 / 鎖骨3〜6週 / 肋骨2〜3週 / 中手骨・指骨3〜4週 / 第5中足骨基部4〜6週（部位・年齢で調整、医師の指示優先）',
        '固定の緩み・食い込み・皮膚障害を毎回確認',
      ],
      redFlags: ['固定遠位のしびれ・蒼白・冷感（循環障害）', '固定内の激痛（コンパートメント症候群疑い）', '発熱・固定内の悪臭'],
      outcomes: ['疼痛NRS', '腫脹（周径cm）', '固定状態の確認'],
      evidence: 'consensus',
      durationWeeks: '部位により2〜6週（目安・医師指示優先）',
    },
    {
      order: 2,
      title: '固定除去後・可動域回復期',
      goals: ['関節可動域の段階的回復', '浮腫の解消', '基礎筋力の再獲得', '（下肢）部分荷重から全荷重へ'],
      exercises: [
        { name: '温熱後の自動・自動介助可動域訓練', dose: '10回×3セット/日', notes: '疼痛自制内で愛護的に' },
        { name: '軽負荷の筋力訓練', dose: 'セラバンド等、10回×2〜3セット' },
        { name: '（下肢）段階的荷重歩行', dose: '1/3荷重→1/2→全荷重', notes: '医師の許可範囲で' },
        { name: '浮腫管理（挙上・軽擦）', dose: '適宜' },
      ],
      advanceCriteria: [
        { label: '可動域', target: '健側比80%以上（目安）' },
        { label: '（下肢）全荷重歩行', target: '疼痛なく可能' },
        { label: '日常生活動作', target: '大きな支障なし' },
      ],
      precautions: ['癒合直後の骨強度は不十分 — 他動での強い矯正・急な負荷は避ける'],
      redFlags: ['運動後に増悪し翌日まで残る疼痛', '再腫脹の持続', 'CRPS徴候'],
      outcomes: ['関節可動域(°)', '疼痛NRS', '周径(cm)'],
      evidence: 'consensus',
      durationWeeks: '固定除去後2〜4週（目安）',
    },
    {
      order: 3,
      title: '筋力・機能回復期',
      goals: ['筋力の健側比90%回復', '持久力・巧緻性の回復', '仕事・家事動作の完全復帰'],
      exercises: [
        { name: '漸増抵抗運動', dose: '8〜12回×3セット、週2〜3回' },
        { name: '（上肢）握力・巧緻動作訓練', dose: 'グリップ・つまみ動作' },
        { name: '（下肢）カーフレイズ・スクワット', dose: '10回×3セット' },
        { name: '有酸素運動', dose: '20〜30分、低〜中強度' },
      ],
      advanceCriteria: [
        { label: '筋力', target: '健側比90%以上（目安）' },
        { label: '疼痛', target: '動作時NRS 1以下' },
        { label: '職場・家庭での動作', target: '制限なし' },
      ],
      precautions: ['疼痛・腫脹が出た場合は負荷を一段階戻す'],
      redFlags: ['負荷に比例しない疼痛の増悪'],
      outcomes: ['筋力（握力kg・MMT）', '可動域(°)', '疼痛NRS'],
      evidence: 'consensus',
      durationWeeks: '4〜8週（目安）',
    },
    {
      order: 4,
      title: 'スポーツ・重労働復帰期',
      goals: ['衝撃負荷への耐性獲得', '競技・重労働への段階的復帰', '再受傷予防'],
      exercises: [
        { name: 'プライオメトリック（部位に応じて）', dose: '低強度から段階的に' },
        { name: '競技動作ドリル', dose: '種目特異的に' },
        { name: '再発予防エクササイズ', dose: 'バランス・固有受容感覚訓練' },
      ],
      advanceCriteria: [
        { label: '医師の競技復帰許可', target: '取得済み' },
        { label: '競技動作', target: '疼痛・不安感なく実施可能' },
      ],
      precautions: ['骨癒合完了後も骨のリモデリングは数ヶ月続く — 衝撃負荷は段階的に'],
      redFlags: ['同部位の疼痛再燃（疲労骨折・再骨折疑い）'],
      outcomes: ['競技特異的テスト', '疼痛NRS'],
      evidence: 'expert_opinion',
      durationWeeks: '個人差大（医師と相談）',
    },
  ],
}

// ─── 脱臼（整復後・保存療法） ────────────────────────────────────────────────
const DISLOCATION: ProtocolTemplate = {
  key: 'dislocation',
  title: '脱臼（整復後）固定・リハビリテーション',
  joint: 'shoulder',
  discussion: [
    {
      role: '柔道整復師',
      emoji: '🦴',
      focus: '整復後の固定管理と再脱臼予防',
      recommendations: [
        '脱臼の施術は応急手当を除き医師の同意を得て行う（柔道整復師法）',
        '【部位別固定期間の目安】肩関節（初回・若年）: 約3週 / 肩関節（40歳以上）: 1〜2週で早期運動へ / 肘関節（単純脱臼）: 1〜2週以内 / 指PIP関節: 2〜3週 / 肩鎖関節TypeⅠ〜Ⅱ: 三角巾1〜3週（いずれも要確認）',
        '固定肢位・期間は年齢とのトレードオフ — 若年は再脱臼予防を、中高年は拘縮予防を優先',
        '整復後は必ず神経・血管損傷の有無を確認（肩なら腋窩神経領域の感覚）',
      ],
      cautions: [
        '整復困難・骨折合併疑い（脱臼骨折）は直ちに医療機関へ',
        '反復性脱臼（2回目以降）は手術適応の可能性 — 専門医への紹介を検討',
      ],
    },
    {
      role: '整形外科医視点',
      emoji: '🏥',
      focus: '固定方法のエビデンスと手術適応の見極め',
      recommendations: [
        '肩前方脱臼の外旋位固定は再脱臼予防効果の報告があるがエビデンスは混在（要確認）— 実施可能性も考慮し内旋位固定が現実的な選択肢',
        '若年アスリートの初回肩脱臼は再脱臼率が高い（報告により50%超）— 復帰時期・手術適応を専門医と相談',
        '肘脱臼は3週を超える固定で拘縮リスクが大きく上がる — 安定性が確認できれば早期運動を',
      ],
      cautions: [
        'Bankart損傷・Hill-Sachs損傷などの合併は画像評価が必要',
        '脱臼を繰り返すほど関節の安定化組織は破綻する',
      ],
    },
    {
      role: 'リハビリ担当PT視点',
      emoji: '💪',
      focus: '安定化筋の再教育と段階的な可動域拡大',
      recommendations: [
        '固定中から手指・手首の運動と等尺性収縮で萎縮を防ぐ',
        '肩は腱板・肩甲骨周囲筋の再教育を最優先（アウターより先にインナー）',
        '脱臼肢位（肩なら外転+外旋の複合）への可動域拡大は最後に慎重に',
      ],
      cautions: [
        '早期の脱臼肢位ストレッチは再脱臼リスク',
        '見かけの可動域回復に安定性の回復が追いついていない時期が最も危険',
      ],
    },
  ],
  consensusNotes:
    '脱臼の施術は応急手当を除き医師の同意が必要（柔道整復師法）。固定期間は「若年ほど再脱臼予防のため長め（肩で約3週）、中高年ほど拘縮予防のため短め（1〜2週）」が原則。反復性脱臼は保存療法の限界があるため手術適応の見極めを怠らないこと。',
  phases: [
    {
      order: 1,
      title: '固定期（整復・安静）',
      goals: ['整復位の維持', '損傷組織の初期治癒', '疼痛・腫脹の管理', '固定範囲外の機能維持'],
      exercises: [
        { name: '手指・手首の自動運動（肩・肘脱臼の場合）', dose: '10回×3セット/日', notes: '浮腫予防' },
        { name: '等尺性収縮（固定内の筋）', dose: '5秒×10回×3セット', notes: '疼痛のない範囲' },
        { name: 'アイシング', dose: '受傷後48〜72時間、20分×複数回' },
        { name: '姿勢・肩甲骨のセッティング（肩の場合）', dose: '固定中から意識づけ' },
      ],
      advanceCriteria: [
        { label: '固定期間の完了', target: '肩(若年)約3週/肩(40歳以上)1〜2週/肘1〜2週/指PIP2〜3週（目安・医師指示優先）' },
        { label: '安静時疼痛', target: 'NRS 2以下' },
        { label: '神経・血管症状', target: 'なし' },
      ],
      precautions: [
        '若年者の肩は固定短縮で再脱臼リスク増、中高年は固定延長で拘縮リスク増 — 年齢で調整',
        '固定中も神経症状（しびれ・感覚低下）を毎回確認',
      ],
      redFlags: ['腋窩神経麻痺の徴候（肩外側の感覚低下・三角筋収縮不全）', '循環障害', '再脱臼感'],
      outcomes: ['疼痛NRS', '神経症状の有無', '固定状態'],
      evidence: 'consensus',
      durationWeeks: '部位・年齢により1〜3週（目安・医師指示優先）',
    },
    {
      order: 2,
      title: '可動域回復期（脱臼肢位は回避）',
      goals: ['安全域での可動域回復', '腱板・安定化筋の活性化', '日常生活動作の再獲得'],
      exercises: [
        { name: '振り子運動（肩の場合）', dose: '各方向10回×3セット' },
        { name: '安全域での自動介助可動域訓練', dose: '10回×3セット', notes: '肩: 外転90°まで・外旋は中間位まで（目安）' },
        { name: 'インナーマッスル等尺性訓練', dose: '内旋・外旋 各10回×3セット', notes: '低負荷で' },
        { name: '肩甲骨周囲筋訓練', dose: 'セッティング・シュラッグ' },
      ],
      advanceCriteria: [
        { label: '安全域の可動域', target: '疼痛なく獲得' },
        { label: '不安感（apprehension）', target: '日常動作でなし' },
        { label: '基礎的な筋収縮', target: '内外旋とも良好' },
      ],
      precautions: ['脱臼肢位（肩: 外転+外旋）への複合運動はこの時期避ける', '他動での強いストレッチ禁止'],
      redFlags: ['亜脱臼感・不安感の頻発', '夜間痛の持続'],
      outcomes: ['可動域(°)', '疼痛NRS', '不安感の有無'],
      evidence: 'consensus',
      durationWeeks: '固定除去後2〜4週（目安）',
    },
    {
      order: 3,
      title: '筋力強化・安定化期',
      goals: ['腱板・安定化筋の筋力強化', '全可動域の回復', '動的安定性の獲得'],
      exercises: [
        { name: 'セラバンド内外旋訓練', dose: '15回×3セット、漸増' },
        { name: '肩甲骨安定化訓練', dose: 'プッシュアッププラス等' },
        { name: '全可動域への段階的拡大', dose: '脱臼肢位方向は最後に慎重に' },
        { name: 'クローズドキネティックチェーン訓練', dose: '壁押し→四つ這い→プランク' },
      ],
      advanceCriteria: [
        { label: '筋力', target: '健側比90%以上（目安）' },
        { label: '全可動域', target: '不安感なく獲得' },
        { label: 'apprehension test', target: '陰性（要確認）' },
      ],
      precautions: ['可動域と筋力・安定性のバランスを常に確認'],
      redFlags: ['再脱臼・亜脱臼', '特定肢位での強い不安感の残存'],
      outcomes: ['筋力（内外旋）', '可動域(°)', 'apprehensionの有無'],
      evidence: 'consensus',
      durationWeeks: '4〜8週（目安）',
    },
    {
      order: 4,
      title: '競技復帰期・再脱臼予防',
      goals: ['競技動作への段階的復帰', '再脱臼予防プログラムの習慣化'],
      exercises: [
        { name: '競技特異的動作訓練', dose: '非接触→制限付き接触→完全復帰' },
        { name: 'プライオメトリック（上肢）', dose: '壁ドリブル・キャッチボール等' },
        { name: '再脱臼予防エクササイズ', dose: '継続的に週2〜3回' },
      ],
      advanceCriteria: [
        { label: '筋力・可動域', target: '健側同等' },
        { label: '競技動作', target: '不安感なく全力で可能' },
        { label: '（コンタクト競技）復帰時期', target: '専門医と相談のうえ決定' },
      ],
      precautions: ['若年アスリートは再脱臼率が高い — 復帰後も予防エクササイズを継続', '2回目以降の脱臼時は手術適応を専門医に相談'],
      redFlags: ['再脱臼'],
      outcomes: ['競技復帰度', '再脱臼の有無'],
      evidence: 'expert_opinion',
      durationWeeks: '受傷後3ヶ月〜（競技・部位による）',
    },
  ],
}

// ─── 捻挫・靭帯損傷（保存療法・汎用） ────────────────────────────────────────
const SPRAIN_LIGAMENT: ProtocolTemplate = {
  key: 'sprain_ligament',
  title: '捻挫・靭帯損傷（保存療法）リハビリテーション',
  joint: 'other',
  discussion: [
    {
      role: '柔道整復師',
      ...
      focus: '重症度評価と固定期間の設定',
      recommendations: [
        '【重症度別固定期間の目安】Ⅰ度（伸長・微細損傷）: 固定は数日以内かテーピングのみ・早期運動 / Ⅱ度（部分断裂）: 装具・テーピング2〜3週 / Ⅲ度（完全断裂）: 装具3〜6週（部位により手術検討・要確認）',
        '【部位別の目安】膝内側側副靭帯（MCL）Ⅱ度: ヒンジ付装具3〜4週・Ⅲ度: 4〜6週 / 突き指（指側副靭帯）: バディテープ2〜3週 / 手関節捻挫: 2〜3週 / 頚部・腰部の捻挫: 長期固定は推奨されず早期に活動再開（いずれも要確認）',
        '急性期はPEACE & LOVE（保護・挙上・圧迫・教育→負荷・楽観・血流・運動）の原則で管理',
        '完全断裂・骨折合併・関節不安定性が強い場合は医師へ紹介',
      ],
      cautions: [
        '「ただの捻挫」と侮らない — 靭帯損傷の見逃しは慢性不安定症の原因',
        '腫脹が強く荷重不能な場合は骨折除外（画像評価）を優先',
      ],
    },
    {
      role: '整形外科医視点',
      ...
      focus: '手術適応の判断と画像評価',
      recommendations: [
        '足関節はOttawa Ankle Rulesを参考に骨折を除外する',
        '過度な長期固定は関節拘縮・筋萎縮・固有受容感覚低下を招く — 近年は「必要最小限の固定＋早期運動」が主流',
        'Ⅲ度損傷でも部位によっては保存療法の成績が手術と同等（足関節外側靭帯など・要確認）',
      ],
      cautions: [
        '膝の多靭帯損傷・前十字靭帯合併は手術適応の可能性が高い',
        '2〜3週で改善傾向がない場合は再評価・画像検査を',
      ],
    },
    {
      role: 'リハビリ担当PT視点',
      emoji: '💪',
      focus: '固有受容感覚の回復と再受傷予防',
      recommendations: [
        '靭帯損傷後は固有受容感覚（関節位置覚）が低下する — バランス訓練を必ず組み込む',
        '固定中から周囲筋の等尺性収縮で萎縮を予防',
        '再受傷予防にはテーピング・装具よりも神経筋トレーニングの継続が本質',
      ],
      cautions: [
        '疼痛消失＝治癒ではない（靭帯の組織学的修復には6〜12週かかる）',
        '腫脹が引く前の競技復帰は再受傷リスクを大きく上げる',
      ],
    },
  ],
  consensusNotes:
    '捻挫・靭帯損傷は重症度（Ⅰ〜Ⅲ度）評価が全ての起点。固定は「Ⅰ度ほぼ不要・Ⅱ度2〜3週・Ⅲ度3〜6週」が目安だが、近年は必要最小限の固定と早期運動療法が主流。頚部・腰部の捻挫に長期固定は推奨されない。足関節はankle_sprainテンプレートも参照。',
  phases: [
    {
      order: 1,
      title: '急性期（保護・固定期）',
      goals: ['損傷組織の保護', '腫脹・疼痛の最小化', '重症度評価の確定', '固定範囲外の機能維持'],
      exercises: [
        { name: 'PEACE原則による急性期管理', dose: '受傷後48〜72時間', notes: '保護・挙上・圧迫、抗炎症薬の乱用は避ける' },
        { name: '重症度に応じた固定', dose: 'Ⅰ度: テーピングのみ/Ⅱ度: 装具2〜3週/Ⅲ度: 装具3〜6週（目安）' },
        { name: '固定範囲外の自動運動', dose: '10回×3セット/日' },
        { name: '等尺性収縮訓練', dose: '疼痛のない範囲で5秒×10回' },
      ],
      advanceCriteria: [
        { label: '腫脹', target: 'ピークを越え減少傾向' },
        { label: '安静時疼痛', target: 'NRS 2以下' },
        { label: '骨折の除外', target: '確認済み（疑い時は画像）' },
      ],
      precautions: [
        '固定期間の目安 — Ⅰ度: 数日以内 / Ⅱ度: 2〜3週 / Ⅲ度: 3〜6週（MCLⅢ度は4〜6週、突き指2〜3週、頚部・腰部は長期固定非推奨）',
        '完全断裂・強い不安定性は医師へ紹介',
      ],
      redFlags: ['荷重完全不能', '著明な変形', 'しびれ・循環障害', '数日で増悪する腫脹'],
      outcomes: ['疼痛NRS', '腫脹（周径cm）', '重症度グレード'],
      evidence: 'guideline',
      durationWeeks: 'Ⅰ度数日〜Ⅲ度6週（重症度による）',
    },
    {
      order: 2,
      title: '亜急性期（LOVE・可動域と荷重の回復）',
      goals: ['可動域の回復', '正常歩行・基本動作の再獲得', '周囲筋の筋力回復開始'],
      exercises: [
        { name: '疼痛自制内の自動可動域訓練', dose: '10回×3セット/日', notes: '損傷靭帯にストレスがかかる方向は慎重に' },
        { name: '段階的荷重・歩行練習（下肢の場合）', dose: '装具・テーピング下で' },
        { name: 'セラバンド筋力訓練', dose: '10回×3セット、低負荷から' },
        { name: '有酸素運動（患部外）', dose: 'バイク等20分', notes: '血流促進が治癒を助ける' },
      ],
      advanceCriteria: [
        { label: '可動域', target: '健側比80%以上（目安）' },
        { label: '歩行・基本動作', target: '疼痛なく可能' },
        { label: '腫脹', target: 'ほぼ消退' },
      ],
      precautions: ['損傷方向へのストレステストを自分で繰り返さない', '装具は段階的に外す（急に全て外さない）'],
      redFlags: ['不安定感（ガクッと抜ける感じ）の頻発', '腫脹の再燃'],
      outcomes: ['可動域(°)', '疼痛NRS', '周径(cm)'],
      evidence: 'guideline',
      durationWeeks: '2〜4週（目安）',
    },
    {
      order: 3,
      title: '機能回復期（筋力・固有受容感覚）',
      goals: ['筋力の健側比90%回復', '固有受容感覚・バランスの回復', '動的安定性の獲得'],
      exercises: [
        { name: '漸増抵抗運動', dose: '10回×3セット、週2〜3回' },
        { name: '片脚バランス訓練（下肢の場合）', dose: '30秒×3回→不安定面へ進行', notes: '再受傷予防の核' },
        { name: 'ジョギング→ダッシュの段階的再開', dose: '直線→カーブ→方向転換' },
        { name: '関節位置覚トレーニング', dose: '目標角度再現課題など' },
      ],
      advanceCriteria: [
        { label: '筋力', target: '健側比90%以上（目安）' },
        { label: '片脚バランス', target: '健側と同等（下肢）' },
        { label: 'ホップテスト等', target: '健側比85%以上（下肢・目安）' },
      ],
      precautions: ['疲労時にフォームが崩れると再受傷しやすい — 質を優先'],
      redFlags: ['特定動作での不安定感の残存（慢性不安定症への移行疑い）'],
      outcomes: ['筋力', 'バランステスト', 'ホップテスト'],
      evidence: 'guideline',
      durationWeeks: '3〜6週（目安）',
    },
    {
      order: 4,
      title: '競技復帰期・再受傷予防',
      goals: ['競技動作の完全再獲得', '再受傷予防プログラムの定着'],
      exercises: [
        { name: '競技特異的ドリル', dose: '強度・複雑さを段階的に' },
        { name: 'アジリティ・カッティング訓練', dose: '予測→非予測課題へ' },
        { name: '神経筋トレーニングの継続', dose: '週2〜3回を復帰後も継続', notes: '再受傷率を下げる最重要要素' },
        { name: '必要に応じたテーピング・装具', dose: '復帰初期のみ、依存させない' },
      ],
      advanceCriteria: [
        { label: '競技動作', target: '全力で疼痛・不安感なし' },
        { label: '心理的準備', target: '恐怖感なし' },
      ],
      precautions: ['復帰後3ヶ月は再受傷リスクが高い時期 — 予防エクササイズを継続'],
      redFlags: ['再受傷', '腫脹を伴う疼痛の再燃'],
      outcomes: ['競技復帰度', '再受傷の有無'],
      evidence: 'guideline',
      durationWeeks: '重症度により受傷後3週〜3ヶ月',
    },
  ],
}
...
export function findBestTemplate(diagnosis: string, joint?: string): ProtocolTemplate | null {
  ...
  if (d.includes('骨折')) return PROTOCOL_TEMPLATES.fracture_conservative
  if (d.includes('脱臼') || d.includes('亜脱臼')) return PROTOCOL_TEMPLATES.dislocation
  if (d.includes('捻挫') || d.includes('靱帯') || d.includes('靭帯') || d.includes('突き指') || d.includes('mcl')) return PROTOCOL_TEMPLATES.sprain_ligament
